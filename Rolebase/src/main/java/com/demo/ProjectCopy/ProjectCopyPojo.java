...
public class ProjectCopyPojo {
	...
	private String projid,projname,description,projstartdate,projenddate,totalemp,pm,hr;
	private String assignedby,empjoindate,projassigneddate;
